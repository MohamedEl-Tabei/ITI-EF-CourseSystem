...
{
    public partial class FormInstructorUpdateDelete : Form
    {
        ...
        public FormInstructorUpdateDelete()
        {
            InitializeComponent();
        ...
        {
            var id = instructorUpdate.Id;
            managerInstructor.Delete(id);
            cbInstructorsPhone.DataSource = managerInstructor.InstructorsPhone();
        }
    }
}
