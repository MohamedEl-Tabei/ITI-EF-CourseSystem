...
{
    public partial class FormDepartmentGetAndUpdateAndDelete : Form
    {
        ...
        public FormDepartmentGetAndUpdateAndDelete()
        {
            InitializeComponent();
        ...
        {
            var id = departmentUpdate.Id.ToString();
            managerDepartment.Delete(Guid.Parse(id));
            cbDepartment.DataSource = managerDepartment.Get();
        }
    }
}
